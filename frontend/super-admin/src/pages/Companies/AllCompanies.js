...
import { getAdminAllCompanies } from "../../services/adminApi";
...
const AllCompanies = () => {
  ...
  const viewHandler = (data) => {
    navigate(`/AllCompanies/ViewAllCompanies/${data.company_id}`, {
      state: data,
    });
  };
                ...
                <tr key={id}>
                  ...
                  <td>
                    <ActionButton
                      ...
                      editlink={`/AllCompanies/AddAllCompany/${data.company_id}`}
                      deleteOnclick={() => {
                  ...
                  {/* {console.log("data", data.gst_details)} */}
                </tr>
              ))}
            </tbody>
          </Table>
