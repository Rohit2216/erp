...
import {
  getAdminAllContractorsContacts,
  getAdminUpdateContractorsContacts,
...
const ContractorsContacts = () => {
  ...
  const fetchContactsData = async () => {
    const res = await getAdminAllContractorsContacts(search, pageSize, pageNo);
    if (res.status) {
  ...
  const handleRejected = async () => {
    ...
    const res = await getAdminUpdateContractorsContacts(sData);
    if (res.status) {
