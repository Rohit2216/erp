...
const CreateOtherComplaint = ({ props, allOrderVia, complaintType }) => {
  ...
  return (
    <>
      ...
      <Form.Group as={Col} md="4">
        <Form.Label>
          Zone Name <span className="text-danger fw-bold">*</span>
        </Form.Label>
        <Select
          menuPortalTarget={document.body}
          className="text-primary"
      ...
      <Form.Group as={Col} md="4">
        <Form.Label>
          Regional Office Name <span className="text-danger fw-bold">*</span>
        </Form.Label>
        <Select
          menuPortalTarget={document.body}
          className="text-primary"
      ...
      <Form.Group as={Col} md="4">
        <Form.Label>
          Sales Area Name <span className="text-danger fw-bold">*</span>
        </Form.Label>
        <Select
          menuPortalTarget={document.body}
          className="text-primary"
