      ...
      <div className="overflow-auto p-2">
        <Table className="text-body bg-new Roles">
          ...
          <tbody>
            ...
            {resolvedData?.map((complaint, idx) => (
              <tr key={idx}>
                ...
                <td>{moment(complaint.resolved_on).format("YYYY-MM-DD")}</td>
                <td>{complaint.resolved_by_name}</td>
                <td className="text-orange">Resolved</td>
                <td>
                  <ActionButton
