...
const AllNewComplaint = ({ handleShow, setEdit, refresh }) => {
      ...
      <div className="overflow-auto p-2">
        <Table className="text-body bg-new Roles">
          ...
          <tbody>
            ...
            {newComplaints?.map((complaint, idx) => (
              <tr key={idx}>
                ...
                <td className="text-success">New Complaints</td>
                <td>
                  <ActionButton
                    hideDelete={"d-none"}
                    eyelink={`/AllComplaintsMasterdata/ViewUserComplaint/${complaint.id}`}
                    editlink={`/AllComplaintsMasterdata/AddComplaintsMasterdata/${complaint.id}`}
                  />
                </td>
              </tr>
            ))}
        ...
        <ReactPagination
          ...
          nextClassName={
            pageSize == pageDetail?.total
              ? newComplaints.length - 1 < pageSize
                ? "danger-combo-disable pe-none"
                : "success-combo"
              : newComplaints.length < pageSize
              ? "danger-combo-disable pe-none"
              : "success-combo"
          }
