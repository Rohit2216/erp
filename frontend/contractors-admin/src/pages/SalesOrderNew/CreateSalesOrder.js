...
import { addSoSchema } from "../../utils/formSchema";
...
const CreateSalesOrder = () => {
  ...
  const handleChecksoIsExists = async (e, setFieldValue) => {
    const soNumber = e.target.value;
    const res = await getCheckSoIsExists(soNumber);
    if (res.status) {
      toast.error(res.message);
    }
    if (setFieldValue) {
      setFieldValue("so_number", soNumber);
    }
  };
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    const modifiedsoItems = values?.so_items?.map((item) => ({
    ...
    formData.append("so_date", values.so_date);
    ...
    formData.append(
      "amount",
      values.so_for == "1" ? totalItemAmount : values.so_amount
    );
    formData.append("so_for", values.so_for.toString());
    formData.append("so_items", JSON.stringify(modifiedsoItems));
  ...
  const validate = (values) => {
    const errors = {};
    values.so_items.forEach((item, index) => {
      if (!item.Qty) {
        errors.so_items = errors.so_items || [];
        errors.so_items[index] = {
          ...errors.so_items[index],
          Qty: "is required",
        };
      }
  ...
  return (
    <>
      <Helmet>
        <title>
          {" "}
          {edit?.id ? "Update sales order" : "Create sales order"} · CMS
          Electricals
        </title>
      </Helmet>
      <Col md={12} data-aos={"fade-up"}>
        <CardComponent
          title={`${edit?.id ? t("Update") : t("Create")} ${t("sales order")}`}
        >
          <Formik
            initialValues={{
              so_date: edit.so_date
                ? moment(edit?.so_date).format("YYYY-MM-DD")
                : "",
              ...
              so_items: edit?.sales_order_item?.data?.map((itm) => {
                return {
                  ...itm,
                  item_id: {
                    value: itm.item_id,
          ...
          >
            {(props) => {
              const so_limit = props.values.so_items.reduce(
                  ...
                  <Row className="g-3 align-items-center">
                    <Form.Group as={Col} md={12}>
                      <Stack
                        ...
                        gap={4}
                      >
                        <span className="ps-3">{t("sales order")}: </span>
                    ...
                    <Form.Group className="ms-2" as={Col} md={4}>
                      ...
                      <Select
                        ...
                        onChange={(e) => props.setFieldValue("from_company", e)}
                      />
                    </Form.Group>
                    ...
                    <Form.Group className="ms-2" as={Col} md={4}>
                      ...
                      <Select
                        ...
                        onChange={(e) => props.setFieldValue("to_company", e)}
                      />
                    </Form.Group>
                        ...
                        <div className="mb-2">
                          ...
                          <Select
                            ...
                            onChange={(selectedOption) => {
                              props.setFieldValue("ro_office", selectedOption);
                            }}
                            onBlur={props.handleBlur}
                            isInvalid={Boolean(
                              props.touched.ro_office && props.errors.ro_office
                            )}
                          />
                          <ErrorMessage
                            name="ro_office"
                        ...
                        <Row>
                          <Col md={12}>
                            <div className="mb-2">
                              ...
                              <Form.Control
                                type="date"
                                name="so_date"
                                value={props.values.so_date}
                                onChange={props.handleChange}
                                onBlur={props.handleBlur}
                                isInvalid={Boolean(
                                  props.touched.so_date && props.errors.so_date
                                )}
                              />
                              <ErrorMessage
                                name="so_date"
                          ...
                          <Col md={6}>
                            ...
                            <Form.Control
                              type="text"
                              name="so_number"
                              value={props.values.so_number}
                              onBlur={(e) => {
                                if (props.values.so_number) {
                                  handleChecksoIsExists(e, props.setFieldValue);
                                }
                              }}
                              onChange={props.handleChange}
                              isInvalid={Boolean(
                                props.touched.so_number &&
                                  props.errors.so_number
                              )}
                            />
                            <ErrorMessage
                              name="so_number"
                          ...
                          <Col md={6}>
                            ...
                            <Form.Control
                              type="text"
                              name="limit"
                              disabled={props.values.so_for == "1" && true}
                              value={
                                props.values.so_for == "1"
                                  ? so_limit.toFixed(2)
                                  : props.values.limit
                              }
                              onChange={props.handleChange}
                        ...
                        <Row className="g-3 align-items-center">
                          ...
                          <Form.Group as={Col} md={4}>
                            ...
                            <Form.Control
                              ...
                              onBlur={props.handleBlur}
                              isInvalid={Boolean(
                                props.touched.cr_date && props.errors.cr_date
                              )}
                            />
                          </Form.Group>
                          <Form.Group as={Col} md={4}>
                            ...
                            <Form.Control
                              ...
                              onBlur={props.handleBlur}
                              isInvalid={Boolean(
                                props.touched.cr_code && props.errors.cr_code
                              )}
                            />
                          </Form.Group>
                          <Form.Group as={Col} md={12} className="shadow p-20">
                          ...
                          <Form.Group as={Col} md={12}>
                            <Form.Label>
                              {t("work")} <span className="text-danger">*</span>
                            </Form.Label>
                            <TextareaAutosize
                          ...
                          <Form.Group className="ms-2" as={Col} md={4}>
                            ...
                            <Select
                              ...
                              onChange={(e) => {
                                ...
                                if (props.values.so_for == "2") {
                                  props.setFieldValue(
                                    "so_tax",
                                    (props.values.so_amount * e.percentage) /
                                      100
                                  );
                                }
                              }}
