...
export default function TableSalesOrder({ props, edit, gstTypesData }) {
                    ...
                    {props.values.so_items.map((itm, index) => (
                      <>
                        <tr key={index}>
                          <td>
                            <Form.Control
                              name={`so_items.${index}.OrderLineNumber`}
                          ...
                          "1" ? (
                            <>
                              ...
                              <td className="text-center">{itm.gst_percent}</td>
                            </>
                          ) : (
                            <>
                              <td></td>
                          ...
                          <td>
                            <Form.Control
                              ...
                              placeholder="0"
                              value={props.values.so_for == "2" ? 0 : itm.Qty}
                              type="number"
