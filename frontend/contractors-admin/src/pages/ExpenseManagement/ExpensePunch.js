...
const ExpensePunch = () => {
  ...
  const fetchPunchRequestData = async () => {
    const res = await getPunchRequest(searchTerm, pageSize, pageNo);
    if (res.status) {
    ...
    <>
      ...
      <Col md={12} data-aos={"fade-up"}>
        <Card className="card-bg">
          ...
          >
            <Tab className="pe-none fs-15 fw-bold" title={t("Expense Punch")} />
                            ...
                            <tr key={id1}>
                              ...
                              <td>
                                <ActionButton
                                  ...
                                  approveOnclick={() =>
                                    navigate(
                                      `/approve-expense-request/${data.id}`,
                                      {
                                        state: {
