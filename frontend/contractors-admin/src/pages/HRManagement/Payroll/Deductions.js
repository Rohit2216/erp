...
const Deductions = ({ allUserData, roles }) => {
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    ...
    const res = await CreateDeductions(sData);
    if (res.status) {
        ...
        <Formik
          ...
          initialValues={{
            deduction: [
              ...
              {
                name: t("Employees State Insurance Corporation"),
                applied_type: "",
                applied_on: "",
                value_type: "",
                by_employee: "",
              ...
              {
                name: t("Advance Salary Deductions"),
                applied_type: "",
                applied_on: "",
                value_type: "",
                by_employee: "",
                          ...
                          <Form.Group as={Col} md={6} key={index}>
                            <div className="shadow p-3">
                              ...
                              <Row className="g-3">
                                ...
                                <Col md={6}>
                                  <p className="mb-1">{t("By Employee")}</p>
                                  <Form.Control
                                ...
                                <Col md={6}>
                                  <p className="mb-1">{t("By Employer")}</p>
                                  <Form.Control
