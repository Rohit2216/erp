...
const CreateAllocate = () => {
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    ...
    const res =
      (type == "resolve") ?
        await postReactiveResolveComplaints(sData)
        :
  ...
  return (
    <>
      ...
      <Col md={12} data-aos={"fade-up"} data-aos-delay={200}>
        <CardComponent className={"after-bg-light"} title={type == "resolve" ? ('Resolve Complaint') : 'Assigned'}
        >
          <Formik
                    ...
                    <div className="mt-4 text-center">
                      ...
                      >
                        {props?.isSubmitting ? (
                          ...
                          type == "resolve" ? ('Resolve Complaint') : 'Assigned'
