              ...
              <Row className="g-3 ">
                <div className="d-grid gap-3 p-2 ">
                  ...
                  <div className=" p-2">
                    <Row className="g- m-1">
                      <Col md={4}>
                        <div className="fw-bold fs-8">{t("Task Name")}:</div>
                      </Col>
                      <Col md={8}>
                        <div className=" px-3">{taskData.title}</div>
                      </Col>
                    </Row>

                    <Row className="g- m-1">
                      <Col md={4}>
                        <div className="fw-bold fs-8">{t("Project Name")}:</div>
                      </Col>
                      <Col md={8}>
                        <div className=" px-3">{taskData.project_name}</div>
                      </Col>
                    </Row>
                    ...
                    <Row className="g- m-1">
                      ...
                      <Col md={8}>
                        <div className=" d-grid gap-2 py-2 px-3">
                          {taskData?.collaborators_list?.map((list, idx) => {
                            return (
                              <p
                                className=" small text-gray mb-0 px-1"
                                key={idx}
                              >
                                {idx + 1}. ({list.name})
                              </p>
                    ...
                    <Row className="g- m-1">
                      <Col md={4}>
                        <div className="fw-bold fs-8">{t("Start Date")}:</div>
                      </Col>
                      <Col md={8}>
                        <div className="px-3">
                    ...
                    <Row className="g- m-1">
                      <Col md={4}>
                        <div className="fw-bold fs-8">{t("Deadline")}:</div>
                      </Col>
                      <Col md={8}>
                        <div className=" px-3">
                    ...
                    <Row className="g- m-1">
                      <Col md={4}>
                        <div className="fw-bold fs-8">{t("status")}:</div>
                      </Col>
                      <Col md={8}>
                        <div className=" px-3">
                ...
                <div className="p-2">
                  <div className="shadow h-100 d-grid align-items-center px-3 last-child-none">
                    ...
                    {taskData?.comments?.map((activity, id1) => (
                      <div
                        key={id1}
                        className="d-flex after-css hr-border2 py-3"
                      >
                        <span className="after-span">{t("Activity")}</span>
