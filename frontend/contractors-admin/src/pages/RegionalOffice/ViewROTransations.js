...
import {
  getAllAreaManagerTransactionById,
...
const ViewROTransations = () => {
  ...
  const fetchAreaManagerById = async () => {
    const res = await getAllRegionalOfficeTransactionById(
      search,
      pageSize,
      pageNo,
      id
  ...
  return (
    <CardComponent showBackButton={true} title={"Regional office transactions"}>
      <div className="mb-3">
        <Col md={12}>
              ...
              <table className="table-sm table">
                <tbody>
                  <tr>
                    ...
                    <td>{allRoData.getBalance?.regional_office_name}</td>
                  </tr>
                  <tr>
                    <th>{t("po number")} :</th>
...
export default ViewROTransations;
