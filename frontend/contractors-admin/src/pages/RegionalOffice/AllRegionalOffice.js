...
import PoDetailsInpaymentPaid from "../Billings/PaymentPaid/PoDetailsInpaymentPaid";
        ...
        <Card className="card-bg">
          ...
          >
            ...
            <Tab title={t("payment process")}>
              {activeTab == "3" && <PaymentProcessInRO />}
            </Tab>

            <Tab title={t("done payments")}>
              {activeTab == "4" && <DonePaymentsInRO />}
            </Tab>
